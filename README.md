...
//*      * NEWT503*, it was then unloaded to disk, using the   *    *   FILE 008
//*      * jobs V503J** and the pds'es converted to TSO XMIT   *    *   FILE 008
//*      * format using the jobs V503X**.  All the files are   *    *   FILE 008
...
//*      * are used, as described in the rest of the NEWT503*  *    *   FILE 008
